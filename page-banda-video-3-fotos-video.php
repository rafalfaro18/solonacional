...
<header id="myCarousel" class="carousel slide">
	...
	<div class="item">
		<!-- Set the first background image using inline CSS below. -->
		<div class="fill" style="background-image:url('<?php echo $imagen2['url']; ?>');"></div>
	<div class="carousel-caption">
		<h2><?php echo $imagen2['title']; ?></h2>
	</div>
	</div>
	<div class="item">
		<!-- Set the first background image using inline CSS below. -->
		<div class="fill" style="background-image:url('<?php echo $imagen3['url']; ?>');"></div>
	<div class="carousel-caption">
		<h2><?php echo $imagen3['title']; ?></h2>
	</div>
	</div>
	<div class="item">
		<!-- Set the first background image using inline CSS below. -->
		<div class="fill" style="background-image:url('<?php echo $imagen4['url']; ?>');"></div>
	<div class="carousel-caption">
		<h2><?php echo $imagen4['title']; ?></h2>
	</div>
	</div>
	</div>
	<!-- Controls -->
